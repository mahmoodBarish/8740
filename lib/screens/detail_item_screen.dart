    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: SingleChildScrollView(
              padding: EdgeInsets.only(
                top: mediaQuery.padding.top + scaleH(44), // Account for status bar and header
                bottom: scaleH(118) + mediaQuery.padding.bottom, // Account for bottom action bar and home indicator
              ),
              child: Column(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Divider
                        Container(
                          margin: EdgeInsets.symmetric(horizontal: scaleW(0)), // Match Figma's indent/endIndent visually
                          height: scaleH(1),
          ...
          Positioned(
            top: mediaQuery.padding.top + scaleH(24), // Place below status bar
            left: scaleW(24),
            right: scaleW(24),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // Navigate to checkout screen using go_router
          ...
          Positioned(
            ...
            right: 0,
            child: Container(
              height: mediaQuery.padding.top > 0 ? mediaQuery.padding.top : scaleH(44), // Dynamic height for notch or default
              color: Colors.white,
              alignment: Alignment.bottomCenter, // Align content to the bottom of this container
              padding: EdgeInsets.symmetric(horizontal: scaleW(24)),
              child: Padding(
                padding: EdgeInsets.only(bottom: mediaQuery.padding.top > 0 ? scaleH(10) : scaleH(12)), // Adjust padding for consistent placement
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
          ...
          Positioned(
            ...
            child: Container(
              ...
              height: mediaQuery.padding.bottom > 0 ? mediaQuery.padding.bottom : scaleH(34), // Dynamic height
              alignment: Alignment.center,
              child: Container(
                width: scaleW(134),
                height: scaleH(5),
